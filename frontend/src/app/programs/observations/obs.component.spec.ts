...
describe('ObsComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      imports: [HttpClientTestingModule, ReactiveFormsModule, RouterTestingModule, NgbModule],
      providers: [NgbModal],
      declarations: [ObsComponent, ObsFormComponent, ObsListComponent, ObsMapComponent]
    }).compileComponents();
  }));
